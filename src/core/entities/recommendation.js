...
class Recommendation {
  ...
  static async createRule(ruleData) {
    ...
    const rule = {
      ...
      type: ruleData.type,
      priority: ruleData.priority || RECOMMENDATION_DEFAULTS.PRIORITY,
  ...
  static _evaluateConditions(conditions, context) {
    ...
    switch (conditions.operator) {
      case 'and':
        return conditions.conditions.every((cond) => this._evaluateConditions(cond, context));
      case 'or':
        return conditions.conditions.some((cond) => this._evaluateConditions(cond, context));
      case 'equals':
      ...
      case 'less_than':
        return context[conditions.field] < conditions.value;
      case 'contains':
        return context[conditions.field] && context[conditions.field].includes(conditions.value);
      default:
        return false;
    }
  }
